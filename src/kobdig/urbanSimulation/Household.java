...
public class Household {
     ...
     */
    private ArrayList<PropertyUtility> rentableProperties;
    ...
    public ArrayList<PropertyUtility> getRentableProperties() {
     ...
     */
    public void addPurchasableProperty(PropertyUtility property){
     ...
     * @param property The property to add
     */
    public void addRentableProperty(PropertyUtility property){
